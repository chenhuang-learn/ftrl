...
for L2 in 0.5 1.5 3.0 10.0
do
    java -jar ftrl_train.jar train_samples_m3 1.0 ${L2} 0.1 6086921 >> m3_result
done

for L1 in 0.5 1.5 3.0 10.0
do
    java -jar ftrl_train.jar train_samples_m3 ${L1} 1.0 0.1 6086921 >> m3_result
done
